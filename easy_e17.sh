...
efl_basic="efl evas_generic_loaders e_dbus azy elementary"
efl_extra="imlib2 enlil etrophy geneet python-evas python-ecore python-e_dbus python-edje python-emotion python-elementary shellementary"
bin_basic="exchange e"
bin_extra="clouseau e_cho e-type easyui eblock econcentration econnman editje edje_viewer eenvader.fractal efbb emote empower enjoy enki entrance ephoto eskiss espionnage etypers exactness expedite exquisite eyelight rage shotgun terminology"
e_modules_efl="libeweather"
e_modules_bin="emprint exalt"
e_modules_extra="alarm comp-scale cpu deskshow diskio elfe empris engage eooorg everything-aspell everything-mpris everything-pidgin everything-places everything-shotgun everything-skeleton everything-tracker everything-wallpaper everything-websearch eweather exalt-client exebuf execwatch flame forecasts iiirk itask mail mem moon mpdule net news penguins photo places rain rmb screenshot skel slideshow snow taskbar tclock uptime weather winlist-ng winselector wlan"
e_themes="23oz b_and_w darkness detourious efenniht klok"
