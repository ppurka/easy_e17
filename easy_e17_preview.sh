...
efl_basic="efl evas_generic_loaders e_dbus edje azy ethumb elementary"
efl_extra="imlib2 emotion enlil etrophy geneet libast python-evas python-ecore python-e_dbus python-edje python-emotion python-elementary shellementary"
